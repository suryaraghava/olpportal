        ...
        function courseDetails()
        {
            ...
            for(var index=0;index<res.length;index++)
            {
              ...
              content+='<h5 align="center" class="course-title">'+res[index].title+'</h5>';
               content+='<a  href="'+res[index].courseEngVideoLink+'"  target="_blank">';
               content+='<div align="center" class="course-img"><img src="images/courses/course-2.jpg" />';
               content+='</div>';
               content+='</a>';
            //  content+='<div class="youtube" id="'+youtubelink+'" align="center">';
              
          //  content+='<iframe width="92%" height="200px"';
          //    content+='src="'+res[index].courseEngVideoLink+'" ';
          //  content+='frameborder="0" allowfullscreen></iframe>';
          //  content+='<span style="width:100%;height:25px;" class="glyphicons glyphicons-book"></span>';
          //    content+='</div>';
              content+='<div id="course-details-view" align="center">';
