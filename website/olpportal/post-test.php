...
<div class="container">
<div class="col-xs-12">
<h3 class="featurette-heading">COURSE-1:<span class="text-muted"> POST TEST</span><div class="time-left pull-right">Time Left: <spna class="text-muted">00:00 Hrs</span></div></h3>
...
<!--   ---------------------- Start Details Page video Content -----------------------    -->
    ...
    <div class="container">
       ...
       <ul class="nav navbar-nav footer-menu">
          <li class="active"><a href="user-landing.html">Home</a></li>
          <li>|</li>
